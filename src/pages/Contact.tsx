              ...
              <Card className="community-card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">ghettofoundation@gmail.com<br /></p>
                  </div>
                </div>
              </Card>
              <Card className="community-card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Monday - Friday: 8:00 AM - 5:00 PM<br />Saturday: 9:00 AM - 2:00 PM<br />Sundays: Closed<br  />Public Holidays:closed</p>
                  </div>
                </div>
              </Card>
            </div>
